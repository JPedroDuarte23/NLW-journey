...
export default function Trip() {
    ...
    async function getTripDetails() {
        try {
            ...
            console.log(tripDetails.ends_at)
            setTripDetails({
                ...trip,
    ...
    async function handleUpdateTrip() {
        try {
            ...
            if (!destination || !selectedDates.startsAt || !selectedDates.endsAt) {
                return Alert.alert("Atualizar viagem", "Lembre-se de, além de preencher o destino, selecionar as datas de início e fim da viagem")
            }
    ...
    return (
        <View className="flex-1 px-5 pt-16">
            ...
            <View className="w-full absolute -bottom-1 self-center justify-end pb-5 z-10 bg-slate-950">
            ...
            >
                <View className="gap-4 mt-4">
                    <Text className="text-zinc-400 font-regular leading-6 my-2">
                        ...
                        nas datas de
                        <Text className="font-semibold text-zinc-100">
                            {" "}{dayjs(tripDetails.starts_at).date()} a {dayjs(tripDetails.ends_at).date()}{" "}
